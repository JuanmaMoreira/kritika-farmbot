...
E2 Treasure runtime → DONE (2026-09-18): HIL A PASS + B PASS con 1 Gold Key verificado por GT humano (contador cofre 353→352 + result normalizado + Lobby limpio); freshness por timestamp con barrera causal (`observed_at`, `max_fact_age_s=2.0s`) tras `stale_fact` HIL. E2.2 fast drain: reward-transient local (right button dual-role, cero tap externo durante Gold) + cadence 0.15 estable + full-drain PASS hasta Karat (48 inputs/16.7s, cero premium). Finalize post-Karat auditado 2026-09-18: `TapThroughAnimation` reutilizado, safe point profile-owned (0.85,0.50), postcondicion fresca y telemetria/cupo economico separados; el punto tiene efecto manual HIL pero la ruta productiva nueva queda HIL PENDING. C6b NO INICIADO; no avanzar hasta ese smoke corto.
