...
Craft standalone quedó cerrado y físicamente verificado. Siguiente frente posible, siempre en tarea separada: construir el adapter caller-specific Craft→Equipment Relief, adquiriendo antes las rutas Craft→Combine/Inventory y retornos causales; Craft no debe absorber esa composición. Monster Wave continúa fuera de este checkpoint.
