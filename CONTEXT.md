...
- Trading Center: foundation C1/C2 calibrada (semántica, 5 detectores standalone HIL, adapter + catálogo 22 + smokes PASS) pero sin wiring a runtime productivo ni trades; C3 pendiente;
