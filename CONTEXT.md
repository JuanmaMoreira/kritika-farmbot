...
G cerró sólo adquisición/snapshot del board. El siguiente frente de resource routing es I-impl: definir el planner puro a partir de los hechos observables y de descubrimientos explícitos externos al board; no asumir necesidades, recetas ni Gold-key capacity ausentes. La integración ejecutora MW permanece separada.
