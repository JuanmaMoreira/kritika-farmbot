...
- E2 Treasure (post-V1, hot-context): percepción autónoma promovida (`screen.treasure` global + `TREASURE_SCOPE` + profile/facts) y operaciones enter/execute/leave single-attempt con la capability E; offline + suite verdes, HIL smokes A/B pendientes, batch-10 HIL_NOT_EXERCISED; sin wiring a sesión productiva ni C6b;
