...
- E2 Treasure (post-V1, hot-context): runtime autónomo + fast Gold drain validados hasta Karat (batch-10, cadence 0.15, full drain, cero premium); finalización post-Karat simplificada sobre `TapThroughAnimation` y safe point profile-owned (0.85,0.50). El punto tiene efecto manual HIL, pero la ruta productiva nueva queda HIL PENDING; sin wiring a sesión productiva y C6b NO INICIADO;
