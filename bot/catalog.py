...
STATUS_GUILD_ATTENDANCE_DAILY_ACTIVE = (
    "status.guild_attendance_daily_active"
)
...
ACTIVITY_DAILY_QUESTS_LOADING = "activity.daily_quests_loading"
...
BASE_CONTEXT_RULES = (
    ...
    ContextRule(SCREEN_TRADING, (LANDMARK_TRADING_CENTER_TITLE,), SEMANTIC_CONFIDENCE_THRESHOLD),
    ContextRule(SCREEN_TREASURE, (LANDMARK_TREASURE_TITLE,), SEMANTIC_CONFIDENCE_THRESHOLD),
    ContextRule(
    ...
    ContextRule(
        name=SCREEN_FRIENDS,
        requires=(LANDMARK_FRIENDS_TITLE, LANDMARK_FRIENDS_ALL_BUTTON),
        min_confidence=SEMANTIC_CONFIDENCE_THRESHOLD,
    ),
    ContextRule(
        name=SCREEN_GUILD,
...
OVERLAY_RULES = (
    *(ContextRule(name, (landmark,), SEMANTIC_CONFIDENCE_THRESHOLD)
    ...
    ContextRule(
        name=STATUS_GUILD_ATTENDANCE_DAILY_ACTIVE,
        requires=(
            LANDMARK_GUILD_MESSAGE_TAB,
            INDICATOR_GUILD_ATTENDANCE_DAILY_ACTIVE,
        ),
    ...
    ContextRule(
        name=STATUS_WORLD_BOSS_DAILY_ACTIVE,
        requires=(
            LANDMARK_BATTLE_MODE_SELECT_HEADER,
            INDICATOR_WORLD_BOSS_DAILY_ACTIVE,
        ),
